      ...
      <section className="py-12 md:py-20">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 sm:p-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="font-semibold text-amber-900">敏感</h2>
                </div>
            ...
            <div className="flex items-start gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-5 sm:p-6">
            ...
            <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:flex-wrap">
              ...
              <Link href="/compensation" className="text-sm text-primary hover:underline">查看赔付说明 &rarr;</Link>
